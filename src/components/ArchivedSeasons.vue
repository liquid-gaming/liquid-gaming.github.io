                    ...
                    <v-tab-item>
                        <v-card flat>
                            <v-card-text>
                                ...
                                <StatsTables :topStat="archivedTopStat" :totalStat="archivedTotalStat" :tab="tab" :archive="true"/>
                            </v-card-text>
                        </v-card>
                    </v-tab-item>
                </v-tabs-items>
...
import topStats2 from "@/assets/json/Season2/top-stats.json"
import totalStats2 from "@/assets/json/Season2/total-stats.json"

import topStats3 from "@/assets/json/Season3/top-stats.json"
import totalStats3 from "@/assets/json/Season3/total-stats.json"
export default {
    name: "Seasons",
    components: {
        StatsTables
    ...
    data: function () {
        return {
            ...
            topStatsThree: topStats3,
            totalStatsThree: totalStats3,
    ...
    mounted(){
        this.seasonsList.push(
            {
                topStats: this.topStatsThree,
                totalStats: this.topStatsThree
            },
            {
